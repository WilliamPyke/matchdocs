...
### Step 2: Select Your veMEZO Position
...
|--------|-------------------|
| **Display Name** | Gauge identity |
| **Current APY** | Estimated annual return based on current state |
...
- [Understanding Gauges](/concepts/gauges) - Learn more about what you're voting on
